    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-6">
          {/* Linha com as Logos e o Título Central */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
            {/* Logo 1: Parede de Escalada da UFRN */}
            <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl bg-white border border-amber-200/80 p-2 flex items-center justify-center shrink-0 shadow-xs relative">
              <Image
            ...
            <div className="flex-1 space-y-1">
              ...
              <h1 className="text-xl sm:text-2xl lg:text-[26px] font-extrabold text-slate-900 leading-tight font-serif tracking-tight">
                Escalada na UFRN:{" "}
            ...
            {/* Logo 2: AERN (Alinhada na mesma linha do título, à direita) */}
            <div className="w-28 h-20 sm:w-36 sm:h-24 rounded-2xl bg-white border border-amber-200/80 p-2 flex items-center justify-center shrink-0 shadow-xs relative">
              <Image
        ...
        {/* Coluna Direita / Card de Comunidade & Redes (4 Colunas) */}
        <div className="lg:col-span-4 bg-white border border-slate-200/90 rounded-3xl p-5 sm:p-6 shadow-xs space-y-4">
          ...
          <div className="space-y-2.5">
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <span>Grupo do WhatsApp (Climb UFRN)</span>
              </div>
              <ArrowUpRight className="w-4 h-4 text-white/80" />
            </a>
          </div>
          ...
          <div className="pt-2 flex items-start gap-2 text-[11px] text-slate-600">
            ...
            <span>COESPE — Ginásio Poliesportivo 1 da UFRN, Natal/RN</span>
          </div>
        </div>
      </div>

      {/* ========================================================= */}
      {/* 3. RODAPÉ COM TEXTO ATUALIZADO & FONTE DESTACADA          */}
      {/* ========================================================= */}
